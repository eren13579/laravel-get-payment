...
namespace Moneroo\Laravel\Facades {
    /**
     */
    class PayoutFacade extends \Moneroo\Laravel\Moneroo {
        /**
         * Initialize a payout.
         *
        ...
        {
            /** @var \Moneroo\Laravel\Payout $instance */
         ...
         * @static
         */
        public static function verify($payoutTransactionId)
        {
            /** @var \Moneroo\Laravel\Payout $instance */
            return $instance->verify($payoutTransactionId);
        }
         ...
         * @static
         */
        public static function get($payoutTransactionId)
        {
            /** @var \Moneroo\Laravel\Payout $instance */
            return $instance->get($payoutTransactionId);
        }
        ...
        {
            //Method inherited from \Moneroo\Laravel\Moneroo 
            /** @var \Moneroo\Laravel\Payout $instance */
            return $instance->validateData($data, $rules);
        }
         ...
         * @static
         */
        public static function sendRequest($method, $data, $endpoint)
        {
            //Method inherited from \Moneroo\Laravel\Moneroo 
            /** @var \Moneroo\Laravel\Payout $instance */
            return $instance->sendRequest($method, $data, $endpoint);
        }

            }
    /**
     */
    class PaymentFacade extends \Moneroo\Laravel\Moneroo {
        /**
         * Initialize payment.
         *
         * @param array $data - Array of data to be sent
        ...
        public static function init($data)
        {
            /** @var \Moneroo\Laravel\Payment $instance */
            return $instance->init($data);
        }
         ...
         * @static
         */
        public static function verify($paymentTransactionId)
        {
            /** @var \Moneroo\Laravel\Payment $instance */
            return $instance->verify($paymentTransactionId);
        }
         ...
         * @static
         */
        public static function get($paymentTransactionId)
        {
            /** @var \Moneroo\Laravel\Payment $instance */
            return $instance->get($paymentTransactionId);
        }
         ...
         * @static
         */
        public static function markAsProcessed($paymentTransactionId)
        {
            /** @var \Moneroo\Laravel\Payment $instance */
            return $instance->markAsProcessed($paymentTransactionId);
        }
...
namespace  {
    ...
    class MonerooPayout extends \Moneroo\Laravel\Facades\PayoutFacade {}
    class MonerooPayment extends \Moneroo\Laravel\Facades\PaymentFacade {}
}
